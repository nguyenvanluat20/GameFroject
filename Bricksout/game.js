 // game parameters
 const BALL_SPD = 0.5; //tốc độ bóng
 ...
 const BRICK_ROWS = 5; // starting number of brick rows
 ...
 // colours
 const COLOR_BACKGROUND = "#99FFFF";
 const COLOR_BALL = "red";
 const COLOR_PADDLE = "#333300";
 const COLOR_TEXT = "#FFCC66";
 ...
 canv.style.border = "1px solid #0ff";
